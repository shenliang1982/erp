...
Page({
  ...
  select_title() {
    var t = this;
    t.select_item("FinanceReport.ExternalInCompany.AlxpanelControl2name_money_title_1"
      , "no_money_title_1", "name_money_title_1");
  },
  select_employee() {
    var t = this;
    t.select_item("FinanceReport.ExternalInCompany.AlxpanelControl2name_employee"
      , "no_employee", "name_employee");
  },
  select_currency() {
    var t = this;
    t.select_item("FinanceReport.ExternalInCompany.AlxpanelControl2name_currency"
      ...
      success: function (res) {
        ...
        dd.httpRequest({
          ...
          data: {
            ...
            no_employee: t.data.login.no_employee,
            no_currency: t.data.login.no_currency,
