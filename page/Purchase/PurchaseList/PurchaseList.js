    ...
    dd.showActionSheet({
      ...
      success: (res) => {
        if (res.index == 0) {
          //提交
          dd.httpRequest({
            url: t.data.login.url + "DingCheckWork01.ashx",
            method: 'POST',
            data: {
              username: t.data.login.username,
              code_login: t.data.login.code_login,
              no_purchase_1: d.no_bill,
              name_space: ""
            },
            dataType: 'json',
            success: (res2) => {
              if (res2.data.errcode == 0) dd.alert({ content: "提交成功" });
              else dd.alert({ content: res2.data.errmsg });
            },
            fail: (res2) => {
      ...
      success: function (res) {
        ...
        dd.httpRequest({
          ...
          data: {
            ...
            name_space: "Purchase.PurchaseList.BindinggridControl1"
          },
          dataType: 'json',
          success: (res2) => {
